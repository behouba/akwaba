...
func (a *OrdersManagementStore) SaveOrder(ctx context.Context, o *akwaba.Order) (err error) {
...
func (o *OrdersManagementStore) CancelCancel(ctx context.Context, orderID uint64) (err error) {
