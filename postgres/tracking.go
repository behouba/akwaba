...
func (s *TrackingStore) TrackByShipmentID(shipmentID uint64) (t akwaba.Tracking, err error) {
...
func (s *TrackingStore) TrackByOrderID(orderID uint64) (t akwaba.Tracking, err error) {
	// retreive shipment info
	err = s.db.QueryRow(
		`SELECT 
		shipment_id, order_id, user_id, sender_name, sender_phone, sender_area_id,
