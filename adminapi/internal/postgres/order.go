...
func (o *OrderStore) Pending(areaID int) (orders []akwaba.Order, err error) {
	// rows, err := o.DB.Query(
	// 	`SELECT
...
func (o *OrderStore) Get(id int) (order akwaba.Order, err error) {
	// err = o.DB.QueryRow(
...
func (o *OrderStore) Save(order *akwaba.Order) (id int, err error) {
